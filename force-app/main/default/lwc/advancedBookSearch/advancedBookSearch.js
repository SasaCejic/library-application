...
export default class AdvancedBookSearch extends NavigationMixin(LightningElement) {
  ...
  @wire(getPicklistValues, {
    recordTypeId: "$bookObjectInfo.data.defaultRecordTypeId",
    fieldApiName: CATEGORIES_PICKLIST
  })
  ...
  @wire(getPicklistValues, {
    recordTypeId: "$bookObjectInfo.data.defaultRecordTypeId",
    fieldApiName: LANGUAGE_PICKLIST
  })
  ...
  handleSorting(event) {
    ...
    this.sortFieldName =
      this.sortBy == "NameUrl" ? NAME_FIELD.fieldApiName : this.sortBy;
  }
